...
Dim userEmail : userEmail = Split(IIF( session("userEmail")="","@",session("userEmail") ),"@")
...
<div id="middle_sub">
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<form name="AdminForm" method="POST" action="page1_proc.asp" enctype="multipart/form-data" onsubmit="return check()">
