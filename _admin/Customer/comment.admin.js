	...
	$.ajax({
		...
		success: function(xml){
			...
			$item.each(function(index){
				...
				var btn_html = '';
				if( btnFg == '0' ){
					btn_html = '<a href="#" onclick="deleteComent('+idx+');return false;">삭제</a>';
				}else{
...
function updateComent(idx){
	...
	var html = '' +
		'<div style="width:'+width+'px;" id="updateCommentWrap">'+
			...
			'<button id="comment_submit_update" class="btn" style="width:100px;height:54px;background-color:#999999;">전송</button>' + 
