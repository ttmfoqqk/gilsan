...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_CATE3_L"
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				<tr>
					...
					<td width="50%" align=right><img src="../img/navi_icon.gif"> <%=AdminLeftName%> > 디바이스 API 분류3 관리 </td>
				</tr>
				...
				<tr>
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							...
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">분류명</td>
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="api_02_07_P.asp" enctype="multipart/form-data">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							<tr height="30" align=center bgcolor="f0f0f0">
								...
								<td class="line_box" width="15%">분류1</td>
								<td class="line_box" width="15%">분류2</td>
								<td class="line_box">분류명</td>
								<td class="line_box" width="10%">사용여부</td>
								<td class="line_box" width="10%">순서</td>
							</tr>
							<%
							for iLoop = 0 to cntList
							PageLink = "location.href='api_02_07_W.asp?" & PageParams & "&Idx=" & arrList(FI_Idx,iLoop) & "'"
							%>
				...
				<tr>
					<td align=center colspan=2>
						<a href="api_02_07_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
