...
Dim cate1    : cate1    = IIF( UPLOAD__FORM("cate1")="" , 0 , UPLOAD__FORM("cate1") )
Dim cate2    : cate2    = IIF( UPLOAD__FORM("cate2")="" , 0 , UPLOAD__FORM("cate2") )
Dim cate3    : cate3    = IIF( UPLOAD__FORM("cate3")="" , 0 , UPLOAD__FORM("cate3") )
...
Sub insert()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_CATE4_P"
...
<head>
	...
	if("<%=actType%>" == "UPDATE"){
		...
		top.location.href = "api_02_08_L.asp?<%=pageParams%>";
	}else{
		top.location.href = "api_02_08_L.asp?<%=pageParams%>";
	}
	</script>
