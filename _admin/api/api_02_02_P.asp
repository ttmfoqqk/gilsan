...
Dim code     : code     = TagEncode ( UPLOAD__FORM("code") )
...
Sub insert()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_COUNTRY_CODE_P"
...
<head>
	...
	if("<%=actType%>" == "UPDATE"){
		//top.location.href = "api_02_02_W.asp?<%=pageParams%>&Idx=<%=Idx%>";
		top.location.href = "api_02_02_L.asp?<%=pageParams%>";
	}else{
		top.location.href = "api_02_02_L.asp?<%=pageParams%>";
	}
	</script>
