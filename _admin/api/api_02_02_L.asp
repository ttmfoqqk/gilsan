...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_COUNTRY_CODE_L"
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				<tr>
					...
					<td width="50%" align=right><img src="../img/navi_icon.gif"> <%=AdminLeftName%> > 디바이스 API 국가코드 관리 </td>
				</tr>
				...
				<tr>
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">국가명</td>
								<td class="line_box" width="250"><input type="text" class="input" name="name" value="<%=name%>"></td>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">국가코드명</td>
								<td class="line_box"><input type="text" class="input" name="code" value="<%=code%>"></td>
							</tr>
							<tr>
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="api_02_02_P.asp" enctype="multipart/form-data">
						<input type="hidden" name="actType" value="">
						<input type="hidden" name="sname" value="<%=name%>">
						<input type="hidden" name="scode" value="<%=code%>">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							<tr height="30" align=center bgcolor="f0f0f0">
								...
								<td class="line_box" width="30%">국가코드명</td>
								<td class="line_box">국가명</td>
								<td class="line_box" width="10%">사용여부</td>
								<td class="line_box" width="10%">순서</td>
							</tr>
							<%
							for iLoop = 0 to cntList
							PageLink = "location.href='api_02_02_W.asp?" & PageParams & "&idx=" & arrList(FI_idx,iLoop) & "'"
							%>
							<tr height="30" align=center>
								...
								<td class="line_box" onclick="<%=PageLink%>" style="cursor:hand" align=left><%=arrList(FI_code,iLoop)%></td>
				...
				<tr>
					<td align=center colspan=2>
						<a href="api_02_02_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
