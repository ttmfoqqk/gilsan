...
Sub GetView()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_COUNTRY_CODE_V"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<form name="AdminForm" method="POST" action="api_02_02_P.asp" enctype="multipart/form-data" onsubmit="return save();">
					...
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							<tr>
								...
								<td class="line_box"><input type="text" style="width:20%" id="name" name="name" class="input" value="<%= TagDecode( FI_name )%>"></td>
							</tr>
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">국가코드명</td>
								<td class="line_box"><input type="text" style="width:20%" id="code" name="code" class="input" value="<%= TagDecode( FI_code )%>"></td>
							</tr>
							<tr>
				...
				<tr>
					<td align=center colspan=2>
						...
						<a href="api_02_02_L.asp?<%=PageParams%>"><img src="../img/center_btn_list.gif"></a>
