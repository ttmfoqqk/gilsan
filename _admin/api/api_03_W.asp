...
Sub GetView()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_MASHIUP_V"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<form name="AdminForm" method="POST" action="api_03_P.asp" enctype="multipart/form-data" onsubmit="return submitContents();">
				...
				<tr>
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							...
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">API ID</td>
								<td class="line_box"><input type="text" style="width:100%" id="mashupId" name="mashupId" class="input" value="<%= TagDecode( FI_mashupId )%>"></td>
							</tr>
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">API URL</td>
								<td class="line_box"><input type="text" style="width:100%" id="url" name="url" class="input" value="<%= TagDecode( FI_url )%>"></td>
							</tr>
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">검색태그</td>
							...
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0" width="140">등록현황</td>
								<td class="line_box">
									<select id="status" name="status">
										<option value="1" <%=IIF( FI_status = "1" , "selected" , "" )%>>프로비저닝 대기</option>
										<option value="2" <%=IIF( FI_status = "2" , "selected" , "" )%>>프로비저닝 완료</option>
										<option value="3" <%=IIF( FI_status = "3" , "selected" , "" )%>>삭제</option>
										<option value="4" <%=IIF( FI_status = "4" , "selected" , "" )%>>프로비저닝 실패</option>
									</select>
								</td>
							</tr>
				...
				<tr>
					<td align=center colspan=2>
						...
						<a href="api_03_L.asp?<%=PageParams%>"><img src="../img/center_btn_list.gif"></a>
