...
Dim area      : area      = Trim( Request.Form("area") )
...
Sub Insert()
	...
	with objCmd
		...
		.CommandText      = "KETI_IOT_SETTTING_AREA_P"
		.Parameters("@actType").value   = actType
		.Parameters("@Idx").value       = Idx
		.Parameters("@Ord").value       = Ord
		.Parameters("@Name").value      = area
...
<html>
 ...
 <body>
  ...
  location.href="Setting_02_L.asp?pageNo=<%=pageNo%>"
  </script>
 </body>
</html>