...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_PLATFORM_CATEGORY_L"
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				<tr>
					...
					<td width="50%" align=right><img src="../img/navi_icon.gif"> <%=AdminLeftName%> > 플랫폼 API 분류 관리 </td>
				</tr>
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="api_01_01_P.asp" enctype="multipart/form-data">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							...
							PageLink = "location.href='api_01_01_W.asp?" & PageParams & "&Idx=" & arrList(FI_Idx,iLoop) & "'"
							%>
				...
				<tr>
					<td align=center colspan=2>
						<a href="api_01_01_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
