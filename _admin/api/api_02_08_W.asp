...
Sub GetView()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_CATE4_V"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<form name="AdminForm" method="POST" action="api_02_08_P.asp" enctype="multipart/form-data" onsubmit="return save();">
				...
				<tr>
					<td align=center colspan=2>
						...
						<a href="api_02_08_L.asp?<%=PageParams%>"><img src="../img/center_btn_list.gif"></a>
					</td>
				</tr>
				</form>
			</table>
