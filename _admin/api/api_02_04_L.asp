...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_MODEL_L"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<tr>
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							...
							<tr>
								<td class="line_box" align=center bgcolor="f0f0f0">사용여부</td>
								<td class="line_box">
								...
								<td class="line_box" align=center bgcolor="f0f0f0"> </td>
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="api_02_04_P.asp" enctype="multipart/form-data">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							<tr height="30" align=center bgcolor="f0f0f0">
								...
								<td class="line_box" width="30%">제조사</td>
								<td class="line_box">모델</td>
								<td class="line_box" width="10%">사용여부</td>
								<td class="line_box" width="10%">순서</td>
							</tr>
							<%
							for iLoop = 0 to cntList
							PageLink = "location.href='api_02_04_W.asp?" & PageParams & "&idx=" & arrList(FI_idx,iLoop) & "'"
							%>
							<tr height="30" align=center>
								...
								<td class="line_box" onclick="<%=PageLink%>" style="cursor:hand" align=left><%=arrList(FI_category,iLoop)%></td>
				...
				<tr>
					<td align=center colspan=2>
						<a href="api_02_04_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
