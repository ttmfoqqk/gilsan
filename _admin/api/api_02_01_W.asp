...
Sub GetView()
	...
	with objCmd
		...
		.CommandText      = "KETI_API_DEVICE_CATE1_V"
		...
		<td class=center_cont_area valign=top>
			<table cellpadding=0 cellspacing=0 width="100%" >
				<tr>
					...
					<td width="50%" align=right><img src="../img/navi_icon.gif"> <%=AdminLeftName%> > 디바이스 API 분류1 관리 </td>
				</tr>
				<tr><td class=center_cont_title_bg colspan=2></td></tr>
				

				<form name="AdminForm" method="POST" action="api_02_01_P.asp" enctype="multipart/form-data" onsubmit="return save();">
				...
				<tr>
					<td align=center colspan=2>
						...
						<a href="api_02_01_L.asp?<%=PageParams%>"><img src="../img/center_btn_list.gif"></a>
