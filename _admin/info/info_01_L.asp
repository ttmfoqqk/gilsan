	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
					...
					<td colspan=2 >
						...
						<table cellpadding=0 cellspacing=0 width="100%">
							...
							<tr>
								...
								<td class="line_box"><input type="text" class="input" name="bigo" value="<%=bigo%>"></td>
								...
								<td class="line_box" width="250">
									<select name="tap">
										...
										<option value="10" <%=IIF( tap="10","selected","" )%>>석진길산에스에스티(주)</option>
										<option value="11" <%=IIF( tap="11","selected","" )%>>(주)길산종합건설</option>
										<option value="12" <%=IIF( tap="12","selected","" )%>>(주)길산로지스</option>
									</select>
								</td>
							</tr>
						</table>
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="info_01_P.asp" enctype="multipart/form-data">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							<tr height="30" align=center bgcolor="f0f0f0">
								...
								<td class="line_box" width="15%">계열사</td>
								<td class="line_box" width="15%">종류</td>
								<td class="line_box" width="20%">모델명</td>
								<td class="line_box" >기계사양</td>
							...
							PageLink = "location.href='info_01_W.asp?" & PageParams & "&idx=" & arrList(FI_Idx,iLoop) & "'"
							...
							ElseIf arrList(FI_tap,iLoop)="10" Then
								position_txt = "석진길산에스에스티(주)"
							ElseIf arrList(FI_tap,iLoop)="11" Then
								position_txt = "(주)길산종합건설"
							ElseIf arrList(FI_tap,iLoop)="12" Then
								position_txt = "(주)길산로지스"
							Else
								position_txt = ""
							End If
							...
							<tr height="30" align=center>
								...
								<td class="line_box" onclick="<%=PageLink%>" style="cursor:hand"><%=arrList(FI_spec,iLoop)%></td>
				...
				<tr>
					<td align=center colspan=2>
						<a href="info_01_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
