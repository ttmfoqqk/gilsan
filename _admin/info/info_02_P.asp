...
<%
Dim savePath : savePath = "\m2/" '첨부 저장경로.
...
Dim menu        : menu         = IIF( UPLOAD__FORM("menu")="" , "0" , UPLOAD__FORM("menu") )
Dim title       : title        = UPLOAD__FORM("title")
Dim userName    : userName     = UPLOAD__FORM("userName")
Dim contants    : contants     = UPLOAD__FORM("contants")
...
<head>
	...
	<!--
		...
		top.location.href = "info_02_L.asp?<%=pageParams%>";
	//-->
	</script>
</head>
<body></body>
