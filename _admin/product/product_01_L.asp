	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="product_01_P.asp" enctype="multipart/form-data">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							...
							PageLink = "location.href='product_01_W.asp?" & PageParams & "&idx=" & arrList(FI_idx,iLoop) & "'"
				...
				<tr>
					<td align=center colspan=2>
						<a href="product_01_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
