			...
			<div class="product_tap_area">
				...
				<div class="tap"><a href="page2_1_2.asp" class="<%=IIF( INSTR(LCase(g_url),"/page2_1_2")>0,"over","" )%>">Round-Pipe Package Quantity Standards Table </a></div>
				<div class="tap"><a href="page2_1_3.asp" class="<%=IIF( INSTR(LCase(g_url),"/page2_1_3")>0,"over","" )%>">Square-Pipe Package Quantity Standardization</a></div>
				...
				<div class="tap"><a href="page2_1_6.asp" class="<%=IIF( INSTR(LCase(g_url),"/page2_1_6")>0,"over","" )%>">Round-Pipe Package Quantity Standards Table </a></div>
				<div class="tap"><a href="page2_1_7.asp" class="<%=IIF( INSTR(LCase(g_url),"/page2_1_7")>0,"over","" )%>">Each-pipe Package Quantity Standards Table</a></div>
				<div class="tap"><a href="page2_1_8.asp" class="<%=IIF( INSTR(LCase(g_url),"/page2_1_8")>0,"over","" )%>">Package Tape Color Standards Table by Thickness</a></div>
			</div>
			<%Else%>
