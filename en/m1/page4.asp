...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">Introduction</span><span class="block2">Awards</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<h6 class="msg">Gilsan Pipe Co., Ltd Awards</h6>
			<!--p class="msg underline">
				Confirmation of the award-winning certain competitions and awards to prove it to the public.<br>
				You can see the achievements and superior technology of gilsan pipe.</p-->
