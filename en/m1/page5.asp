...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">Introduction</span><span class="block2">Certificates</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<h6 class="msg">Gilsan Pipe Co., Ltd Certificates</h6>
			<!--p class="msg underline">
				You get to acquire a variety of certificates and mark in and out of countries worldwide recognition technology. <br>
				You can see the achievements and superior technology of gilsan pipe.  
			</p-->
