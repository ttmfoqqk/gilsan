	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<div style="text-align:right;margin-bottom:10px;">
				<button class="btn_bg" type="button" style="width:80px;float:left;margin:0px;" onclick="location.href='page4.asp?<%=PageParams%>'">목록보기</button>
				<%If FI_AdminIdx = "0" And FI_UserId = session("userId") Then %>
				<button class="btn_bg" type="button" style="width:80px;" onclick="location.href='page4_write.asp?<%=PageParams%>&idx=<%=idx%>&actType=mody'">수정</button>
