...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">고객센터</span><span class="block2">길산 갤러리</span>
		</div>
	</div>
		...
		<div id="contant">
			...
			<div id="gallery">
				...
				<%for iLoop = 0 to cntList
					...
					commentCnt = ""
					If arrList(FI_CommentCnt,iLoop) > 0 Then 
						commentCnt = " <span style=""color:red;font-size:10px;position:absolute;top:0px;right:0px;"">[" & arrList(FI_CommentCnt,iLoop) & "]</span>"
					End If
				%>
				<div class="item">
					<div class="img"><a href="page7_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=img%></a></div>
					<div class="title"><a href="page7_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=arrList(FI_Title,iLoop)%></a><%=commentCnt%></div>
