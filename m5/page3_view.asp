...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">고객센터</span><span class="block2">길산공부방</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			<h3 class="title">길산공부방</h3>

			<form name="AdminForm" id="AdminForm" method="POST" action="page3_proc.asp" enctype="multipart/form-data">
			...
			<table cellpadding="0" cellspacing="0" style="border-top:2px solid #4f4f4f;width:100%;font-size:14px;line-height:150%;margin-bottom:10px;">
				...
				<tr style="height:40px;">
					<td style="border-bottom:1px solid #4f4f4f;color:#85868a;padding-left:15px;" colspan="2"><a href="../common/download.asp?pach=/upload/Board/&file=<%=escape(FI_File_name)%>"><%=FI_File_name%></a></td>
				</tr>
				<%End If%>
			</table>
			
			<div style="text-align:right;margin-bottom:10px;">
				<button class="btn_bg" type="button" style="width:80px;float:left;margin:0px;" onclick="location.href='page3.asp?<%=PageParams%>'">목록보기</button>
				<%If FI_AdminIdx = 0 And FI_UserId = session("userId") Then %>
				<button class="btn_bg" type="button" style="width:80px;" onclick="location.href='page3_write.asp?<%=PageParams%>&idx=<%=idx%>&actType=mody'">수정</button>
