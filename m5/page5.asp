...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">고객센터</span><span class="block2">길산행사</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<div id="gallery">
				...
				%>
				<div class="item">
					<div class="img"><a href="page5_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=img%></a></div>
					<div class="title"><a href="page5_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=arrList(FI_Title,iLoop)%></a></div>
