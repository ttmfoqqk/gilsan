...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">고객센터</span><span class="block2">길산축제</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			<h3 class="title">길산축제</h3>

			<form name="AdminForm" id="AdminForm" method="POST" action="page6_proc.asp" enctype="multipart/form-data">
			...
			<div style="text-align:right;margin-bottom:10px;">
				<button class="btn_bg" type="button" style="width:80px;float:left;margin:0px;" onclick="location.href='page6.asp?<%=PageParams%>'">목록보기</button>
				<%If FI_AdminIdx = "0" And FI_UserId = session("userId") Then %>
				<button class="btn_bg" type="button" style="width:80px;" onclick="location.href='page6_write.asp?<%=PageParams%>&idx=<%=idx%>&actType=mody'">수정</button>
