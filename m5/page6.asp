	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<div id="gallery">
				...
				%>
				<div class="item">
					<div class="img"><a href="page6_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=img%></a></div>
					<div class="title"><a href="page6_view.asp?<%=PageParams%>&idx=<%=arrList(FI_idx,iLoop)%>"><%=arrList(FI_Title,iLoop)%></a></div>
