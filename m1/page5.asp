...
<div id="middle_sub">
	...
	<div class="navi_wrap">
		<div class="width_wrap">
			<span class="home">H</span><span class="block1">회사소개</span><span class="block2">인증서</span>
		</div>
	</div>
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<h6 class="msg">길산파이프(주) 인증서</h6>
			<p class="msg underline">
				국 내외의 다양한 인증서와 마크를 획득하여 세계적인 기술력을 인정받고 있습니다.<br>
