...
Call dbopen()
	...
	Call checkGubun()
	If Trim(CHECK_SANO) = "" Then 
		With Response
		 .Write "<script language='javascript' type='text/javascript'>"
		 .Write "alert('거래처가입자만 주문이 가능합니다.');"
...
Sub checkGubun()
	...
	with objCmd
		...
		.Parameters("@actType").value = "gubun"
		.Parameters("@id").value      = session("userId")
		Set objRs = .Execute
	End with
	set objCmd = nothing
		...
		<div id="contant">
			...
			<div class="form_wrap" style="width:730px;">
				...
				<div class="row" style="z-index:100;">
					<label style="width:122px;">주문처 <span class="color_red">*</span></label>
				...
				<div class="row" style="z-index:50;">
					...
					<span style="height:44px;display:inline-block;zoom:1;*display:inline;_display:inline;" id="hidden_length">
						<button type="button" class="reserve_btn" value="4000" style="vertical-align:middle;">4000</button><button type="button" class="reserve_btn" value="6000" style="vertical-align:middle;">6000</button>
					</span><input type="number" id="length" name="length" class="input" style="width:113px;text-align:right;vertical-align:middle;" maxlength="50" min="0" onkeydown="onlyNum();"> mm (코일 길이는 1입니다.)
				</div>

				<div class="row" style="z-index:40;">
					<label style="width:122px;">수량 <span class="color_red">*</span></label>
					<input type="number" id="qty" name="qty" class="input" style="width:113px;text-align:right;" maxlength="12" min="0" onkeydown="onlyNum();"> EA / Kg
				</div>

				<%If FI_CHECK = "0" Then %>
				<div class="row" style="z-index:30;">
					<label style="width:122px;">희망납기일 <span class="color_red">*</span></label>
					<input type="text" id="duedate" name="duedate" class="input" style="width:113px;" onclick="callCalendar(mForm.duedate);" readonly maxlength="10">
				...
				<div class="row" style="z-index:10;">
					...
					<div style="margin-left:122px;"><span class="color_red">1)테이프 부착여부,   2)국내산/수입산 여부,   3)코일 지관삽입 및 단중여부</span></div>
				</div>
				<%End If%>
