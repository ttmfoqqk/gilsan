	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<div style="margin:30px;text-align:center;" id="submit_area">
				...
				<button type="button" class="btn" onclick="document.location.href='page1_1.asp?orderCode=<%=orderCode%>&companyCode=<%=arrList(FI_COCODE,0)%>';">추가주문</button>
				<button type="button" class="btn" onclick="basket_insert();">주문완료</button>
				<%Else%>
				<button type="button" class="btn" onclick="document.location.href='page1_1.asp';">온라인주문</button>
				<%End If%>
