...
Dim searchfg : searchfg = request("searchfg")
...
<div id="middle_sub">
	...
	<div class="width_wrap">
		...
		<div id="contant">
			...
			<form name="form_more_pop" id="form_more_pop" method="GET" onsubmit="$('.btn_wrap').html('검색중입니다.');">
			...
			<table cellpadding="0" cellspacing="0" style="width:100%;font-size:14px;">
				<tr>
					...
					<td style="width:40%;">
						<select class="input" name="cocode" style="width:170px;">
					...
					<td style="width:40%;">
						<input type="text"name="itemname" class="input" maxlength="50" style="width:150px;" value="<%=itemname%>">
					</td>
				</tr>
				...
				<tr>
					<td>두께</td>
					<td>
						<input type="text" name="thick" class="input" maxlength="100" style="width:100px;" value="<%=thick%>">
					</td>
					<td>호칭경</td>
					<td>
						<input type="text" name="extdia" class="input" maxlength="100" style="width:100px;" value="<%=extdia%>">
					</td>
				</tr>
			</table>
			<br>
			
			<center style="line-height:40px;" class="btn_wrap">
