		...
		<div id="contant" style="float:none;margin:0px auto;padding:0px;">
			...
			<div class="form_wrap" style="width:730px;">
				...
				<div class="row" style="z-index:50;">
					...
					</span><input type="number" id="length" name="length" class="input" style="width:113px;text-align:right;vertical-align:middle;" maxlength="12" min="0" onkeydown="onlyNum();"> mm
				</div>

				<div class="row" style="z-index:40;">
					<label style="width:122px;">수량 <span class="color_red">*</span></label>
					<input type="number" id="qty" name="qty" class="input" style="width:113px;text-align:right;" maxlength="12" min="0" onkeydown="onlyNum();"> EA
				</div>
